...
<html lang="en">
  <head>
    ...
    <style>
      ...
      pre { text-align: left; background: #f3f4f6; padding: 1rem; border-radius: 0.5rem; overflow-x: auto; font-size: 12px; color: #dc2626; max-height: 200px; }
  ...
  <body>
    <div class="card">
      ...
      ${errorDetails ? `<pre><code>${errorDetails}</code></pre>` : ""}
      <div class="actions">
