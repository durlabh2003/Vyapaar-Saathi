...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0d5c48" },
      { title: "Vyapaar Saathi — Voice Business Khata" },
      {
        name: "description",
        content:
          "Record sales, expenses, udhaar and payments just by speaking in Hindi, English or Hinglish.",
      },
